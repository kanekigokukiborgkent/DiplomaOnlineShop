...
namespace DiplomaOnlineShop
{
    static public class InitialData
    {
        ...
        {
                  new Products {producător = "Xiaomi", model="Smart Tab M8",        pret = 3000, diagonala_ecranului = 12, rezolutia_ecranului = "2560x1300", memorie_incorporată = 128, RAM = 6, camera_din_spate = 13, camera_frontala = 8, capacitatea_bateriei = 8720, garanție = 24, materialul_carcasei = "aluminiu", dimensiuni = "254,6x166,2x1,4", greutate = 511, culoare = "Gri", Img ="tablet1.PNG", Path="/img/Produse/Tablets/", category = "tablet" },
            new Products {producător = "Poco", model=" Tablet 54 C",          pret = 3293, diagonala_ecranului = 13, rezolutia_ecranului = "2420x1600", memorie_incorporată = 64,  RAM = 3, camera_din_spate = 14, camera_frontala = 6, capacitatea_bateriei = 7322, garanție = 6 , materialul_carcasei = "aluminiu", dimensiuni = "153,5x654,2x9,4", greutate = 600, culoare = "Negru", Img ="tablet2.PNG", Path="/img/Produse/Tablets/" , category = "tablet"},
            new Products {producător = "Samsung", model="Galaxy A3",          pret = 2484, diagonala_ecranului = 14, rezolutia_ecranului = "2304x2344", memorie_incorporată = 165, RAM = 4, camera_din_spate = 12, camera_frontala = 7, capacitatea_bateriei = 6324, garanție = 12, materialul_carcasei = "aluminiu", dimensiuni = "544,1x645,4x8,3", greutate = 612, culoare = "Albastru", Img ="tablet3.PNG", Path="/img/Produse/Tablets/" , category = "tablet"},
            new Products {producător = "LG", model="Aparat GY 78",            pret = 3333, diagonala_ecranului = 11, rezolutia_ecranului = "2743x7367", memorie_incorporată = 134, RAM = 6, camera_din_spate = 15, camera_frontala = 9, capacitatea_bateriei = 7320, garanție = 6,  materialul_carcasei = "aluminiu", dimensiuni = "743,2x343,2x7,3", greutate = 432, culoare = "Argintiu", Img ="tablet4.PNG", Path="/img/Produse/Tablets/" , category = "tablet"},
            new Products {producător = "Apple", model="MacBook Pro ",         pret = 3055, diagonala_ecranului = 10, rezolutia_ecranului = "2735x1345", memorie_incorporată = 28,  RAM = 2, camera_din_spate = 16, camera_frontala = 2, capacitatea_bateriei = 2320, garanție = 48, materialul_carcasei = "aluminiu", dimensiuni = "346,3x466,4x6,2", greutate = 523, culoare = "Blue-Marin", Img ="phone2.PNG", Path="/img/Produse/Telephons/" , category = "phone"},
            new Products {producător = "Xiaomi", model="Flip Hy LY Ky Ny My", pret = 4392, diagonala_ecranului = 15, rezolutia_ecranului = "2724x1783", memorie_incorporată = 29,  RAM = 3, camera_din_spate = 11, camera_frontala = 1, capacitatea_bateriei = 6320, garanție = 36, materialul_carcasei = "aluminiu", dimensiuni = "487,2x821,1x5,3", greutate = 854, culoare = "Alb", Img ="phone3.PNG", Path="/img/Produse/Telephons/" , category = "phone"}
